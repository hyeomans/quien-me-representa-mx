...
insert into gobernacion(actor_politico_id, periodo, estado)
select id, '[09-10-2021, 09-09-2027]'::daterange, 3
...
insert into gobernacion(actor_politico_id, periodo, estado)
select id, '[09-16-2021, 09-15-2027]'::daterange, 4
...
insert into gobernacion(actor_politico_id, periodo, estado)
select id, '[09-08-2021, 09-07-2027]'::daterange, 8
...
insert into gobernacion(actor_politico_id, periodo, estado)
select id, '[10-27-2015, 10-14-2021]'::daterange, 12
...
insert into gobernacion(actor_politico_id, periodo, estado)
select id, '[09-19-2021, 09-18-2027]'::daterange, 18
...
insert into gobernacion(actor_politico_id, periodo, estado)
select id, '[09-13-2021, 09-12-2027]'::daterange, 26
...
insert into actores_politicos (nombre, puesto, img_url, created_at) 
values ('Lic. Carlos Manuel Merino Campos', 'Gubernatura por el estado de TABASCO en período [08-27-2021, 09-12-2027]', 'https://envios.conago.org.mx/uploads/imagenes/gobernadores/TAB_CarlosManuelMerinoCampos.jpg', '2021-04-29 13:00:00') ON CONFLICT (nombre_formatted, puesto) 
DO UPDATE SET img_url = EXCLUDED.img_url;

insert into gobernacion(actor_politico_id, periodo, estado)
select id, '[08-27-2021, 09-12-2027]'::daterange, 27
...
insert into gobernacion(actor_politico_id, periodo, estado)
select id, '[08-31-2021, 08-30-2027]'::daterange, 29
...
insert into gobernacion(actor_politico_id, periodo, estado)
select id, '[09-12-2021, 09-11-2027]'::daterange, 32
